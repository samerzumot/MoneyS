...
type GetDebtPaymentGroupByPayload<T extends DebtPaymentGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<DebtPaymentGroupByOutputType, T['by']> & {
...
export type DebtPaymentCreateInput = {
    ...
    debt: Prisma.DebtAccountCreateNestedOneWithoutPaymentsInput;
};
...
export type DebtPaymentUpdateInput = {
    ...
    debt?: Prisma.DebtAccountUpdateOneRequiredWithoutPaymentsNestedInput;
};
...
export type DebtPaymentOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "debtId" | "amount" | "paymentDate" | "createdAt", ExtArgs["result"]["debtPayment"]>;
