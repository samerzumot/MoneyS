...
// @ts-nocheck 
/*
 * This file exports the `PayoffPlan` model and its related types.
 *
...
export type GetPayoffPlanAggregateType<T extends PayoffPlanAggregateArgs> = {
      [P in keyof T & keyof AggregatePayoffPlan]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregatePayoffPlan[P]>
    : Prisma.GetScalarType<T[P], AggregatePayoffPlan[P]>
}
...
type GetPayoffPlanGroupByPayload<T extends PayoffPlanGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<PayoffPlanGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof PayoffPlanGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], PayoffPlanGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], PayoffPlanGroupByOutputType[P]>
      }
    >
  >
...
export type PayoffPlanCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<PayoffPlanFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface PayoffPlanDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['PayoffPlan'], meta: { name: 'PayoffPlan' } }
  /**
   ...
   * })
  **/
  count<T extends PayoffPlanCountArgs>(
    args?: Prisma.Subset<T, PayoffPlanCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], PayoffPlanCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends PayoffPlanGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, PayoffPlanGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetPayoffPlanGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
