...
// @ts-nocheck 
/*
 * This file exports the `PayoffPlanEntry` model and its related types.
 *
...
export type GetPayoffPlanEntryAggregateType<T extends PayoffPlanEntryAggregateArgs> = {
      [P in keyof T & keyof AggregatePayoffPlanEntry]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregatePayoffPlanEntry[P]>
    : Prisma.GetScalarType<T[P], AggregatePayoffPlanEntry[P]>
}
...
type GetPayoffPlanEntryGroupByPayload<T extends PayoffPlanEntryGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<PayoffPlanEntryGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof PayoffPlanEntryGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], PayoffPlanEntryGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], PayoffPlanEntryGroupByOutputType[P]>
      }
    >
  >
...
export type PayoffPlanEntryCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<PayoffPlanEntryFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface PayoffPlanEntryDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['PayoffPlanEntry'], meta: { name: 'PayoffPlanEntry' } }
  /**
   ...
   * })
  **/
  count<T extends PayoffPlanEntryCountArgs>(
    args?: Prisma.Subset<T, PayoffPlanEntryCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], PayoffPlanEntryCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends PayoffPlanEntryGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, PayoffPlanEntryGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetPayoffPlanEntryGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
